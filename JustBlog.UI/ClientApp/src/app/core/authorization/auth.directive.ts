...
export class AuthorizationDirective {
     ...
     */
    constructor($compile: ng.ICompileService, authService: AuthService, AUTH_EVENT_CONSTANTS: AuthEvent) {
    ...
    public static Factory() {
        let directive: any = ($compile: ng.ICompileService, authService: AuthService, AUTH_EVENT_CONSTANTS: AuthEvent) => {
